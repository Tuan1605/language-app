...
const BASE_CARDS: Flashcard[] = [
  ...
  { id: 't-1', user_id: 'guest', word: 'Incentive', definition: 'Sự khuyến khích, ưu đãi', example: 'The bonus serves as an incentive.', imageUrl: 'https://picsum.photos/seed/Incentive/400/300', language: 'english', category: 'toeic', difficulty: 'intermediate', topic: 'Business', status: 'new', repetition: 0, interval: 0, easiness: 2.5, next_review: null, created_at: new Date().toISOString() },
  { id: 't-2', user_id: 'guest', word: 'Delegate', definition: 'Ủy thác, giao phó', example: 'Managers must delegate tasks effectively.', imageUrl: 'https://picsum.photos/seed/Delegate/400/300', language: 'english', category: 'toeic', difficulty: 'intermediate', topic: 'Business', status: 'new', repetition: 0, interval: 0, easiness: 2.5, next_review: null, created_at: new Date().toISOString() },
  { id: 't-3', user_id: 'guest', word: 'Requirement', definition: 'Yêu cầu bắt buộc', imageUrl: 'https://picsum.photos/seed/Requirement/400/300', language: 'english', category: 'toeic', difficulty: 'beginner', topic: 'General', status: 'new', repetition: 0, interval: 0, easiness: 2.5, next_review: null, created_at: new Date().toISOString() },
  { id: 't-4', user_id: 'guest', word: 'Procedure', definition: 'Quy trình, thủ tục', imageUrl: 'https://picsum.photos/seed/Procedure/400/300', language: 'english', category: 'toeic', difficulty: 'beginner', topic: 'Office', status: 'new', repetition: 0, interval: 0, easiness: 2.5, next_review: null, created_at: new Date().toISOString() },
  { id: 't-5', user_id: 'guest', word: 'Compliance', definition: 'Sự tuân thủ', imageUrl: 'https://picsum.photos/seed/Compliance/400/300', language: 'english', category: 'toeic', difficulty: 'advanced', topic: 'Legal', status: 'new', repetition: 0, interval: 0, easiness: 2.5, next_review: null, created_at: new Date().toISOString() },
  { id: 't-6', user_id: 'guest', word: 'Acquisition', definition: 'Sự thâu tóm/mua lại', imageUrl: 'https://picsum.photos/seed/Acquisition/400/300', language: 'english', category: 'toeic', difficulty: 'advanced', topic: 'Business', status: 'new', repetition: 0, interval: 0, easiness: 2.5, next_review: null, created_at: new Date().toISOString() },

  // --- JLPT N2 CORE ---
  { id: 'n-1', user_id: 'guest', word: '把握 (はあく)', definition: 'Nắm bắt, thấu hiểu', imageUrl: 'https://picsum.photos/seed/haaku/400/300', language: 'japanese', category: 'n2', difficulty: 'intermediate', topic: 'Academic', status: 'new', repetition: 0, interval: 0, easiness: 2.5, next_review: null, created_at: new Date().toISOString() },
  { id: 'n-2', user_id: 'guest', word: '考慮 (こうりょ)', definition: 'Xem xét, cân nhắc', imageUrl: 'https://picsum.photos/seed/kouryo/400/300', language: 'japanese', category: 'n2', difficulty: 'intermediate', topic: 'Academic', status: 'new', repetition: 0, interval: 0, easiness: 2.5, next_review: null, created_at: new Date().toISOString() },
  { id: 'n-3', user_id: 'guest', word: '徹底 (てってい)', definition: 'Triệt để', imageUrl: 'https://picsum.photos/seed/tettei/400/300', language: 'japanese', category: 'n2', difficulty: 'advanced', topic: 'Work', status: 'new', repetition: 0, interval: 0, easiness: 2.5, next_review: null, created_at: new Date().toISOString() },
  { id: 'n-4', user_id: 'guest', word: '迅速 (じんそく)', definition: 'Nhanh chóng', imageUrl: 'https://picsum.photos/seed/jinsoku/400/300', language: 'japanese', category: 'n2', difficulty: 'advanced', topic: 'Work', status: 'new', repetition: 0, interval: 0, easiness: 2.5, next_review: null, created_at: new Date().toISOString() },

  // --- BEGINNER ---
  { id: 'f-2', user_id: 'guest', word: 'Hello', definition: 'Xin chào', imageUrl: 'https://picsum.photos/seed/Hello/400/300', language: 'english', category: 'toeic', difficulty: 'beginner', topic: 'Daily Life', status: 'new', repetition: 0, interval: 0, easiness: 2.5, next_review: null, created_at: new Date().toISOString() },
];
