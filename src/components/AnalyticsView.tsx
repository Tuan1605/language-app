  ...
  return (
    <div className="bg-bg-card lingo-card p-6 sm:p-10 max-w-5xl mx-auto w-full animate-in slide-in-from-bottom-8 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
        {/* Vocabulary Progress */}
        <div className="bg-gray-bg border-2 border-gray-path rounded-3xl p-6 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-6 bg-tint-green border-2 border-green rounded-3xl text-center flex flex-col justify-center">
          ...
          <div className="p-6 bg-tint-blue border-2 border-blue rounded-3xl text-center flex flex-col justify-center">
          ...
          <div className="col-span-2 p-6 bg-tint-red border-2 border-red rounded-3xl text-center flex flex-col justify-center overflow-hidden">
            <p className="text-[10px] md:text-xs font-black text-red uppercase opacity-80 tracking-wider">Exam Rank</p>
            <p className="text-xl md:text-2xl font-black text-red mt-1 break-words leading-tight">
        ...
        <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
          {filtered.length > 0 ? (
            [...filtered].reverse().map((res) => (
              <div key={res.id} className="p-5 bg-bg-hover border-2 border-border-main rounded-2xl flex justify-between items-center hover:border-blue transition-colors">
                <div className="flex items-center gap-4">
                  <div className={`w-12 h-12 flex-shrink-0 rounded-xl flex items-center justify-center text-white font-black shadow-lg ${res.type === 'full-exam' ? 'bg-blue' : 'bg-green'}`}>
