...
export const HIRAGANA: KanaGroup[] = [
  {
    ...
    chars: [
      ...
      {kana: 'や', romaji: 'ya'}, {kana: '', romaji: '', isEmpty: true}, {kana: 'ゆ', romaji: 'yu'}, {kana: '', romaji: '', isEmpty: true}, {kana: 'よ', romaji: 'yo'},
      {kana: 'ら', romaji: 'ra'}, {kana: 'り', romaji: 'ri'}, {kana: 'る', romaji: 'ru'}, {kana: 'れ', romaji: 're'}, {kana: 'ろ', romaji: 'ro'},
      {kana: 'わ', romaji: 'wa'}, {kana: '', romaji: '', isEmpty: true}, {kana: '', romaji: '', isEmpty: true}, {kana: '', romaji: '', isEmpty: true}, {kana: 'を', romaji: 'wo'},
      {kana: 'ん', romaji: 'n'}, {kana: '', romaji: '', isEmpty: true}, {kana: '', romaji: '', isEmpty: true}, {kana: '', romaji: '', isEmpty: true}, {kana: '', romaji: '', isEmpty: true},
    ]
  },
  {
    name: 'Dakuten',
...
export const KATAKANA: KanaGroup[] = [
  {
    ...
    chars: [
      ...
      {kana: 'ヤ', romaji: 'ya'}, {kana: '', romaji: '', isEmpty: true}, {kana: 'ユ', romaji: 'yu'}, {kana: '', romaji: '', isEmpty: true}, {kana: 'ヨ', romaji: 'yo'},
      {kana: 'ラ', romaji: 'ra'}, {kana: 'リ', romaji: 'ri'}, {kana: 'ル', romaji: 'ru'}, {kana: 'レ', romaji: 're'}, {kana: 'ロ', romaji: 'ro'},
      {kana: 'ワ', romaji: 'wa'}, {kana: '', romaji: '', isEmpty: true}, {kana: '', romaji: '', isEmpty: true}, {kana: '', romaji: '', isEmpty: true}, {kana: 'ヲ', romaji: 'wo'},
      {kana: 'ン', romaji: 'n'}, {kana: '', romaji: '', isEmpty: true}, {kana: '', romaji: '', isEmpty: true}, {kana: '', romaji: '', isEmpty: true}, {kana: '', romaji: '', isEmpty: true},
    ]
  },
  {
    name: 'Dakuten',
